...
const HeroSection = () => {
  ...
  // Preload both optimized images so the swap is instant
  useEffect(() => {
            ...
            <div className="relative w-56 h-56 md:w-72 md:h-72 lg:w-80 lg:h-80 transition-transform duration-300 ease-out hover:scale-105 hover:-translate-y-2 cursor-pointer">
              ...
              {profilePhoto ? (
                <div className="relative w-full h-full rounded-full overflow-hidden">
                  <img src={profilePhoto} alt="Vedanti Deshmukh" className="w-full h-full object-cover object-top" loading="eager" decoding="sync" fetchPriority="high" />
